Documentation officielle d'utilisation de **GesSchool**, application web (PWA) de gestion scolaire multi-écoles. Ce document réunit en un seul fichier le démarrage rapide, le manuel complet et le guide destiné aux parents.

## Sommaire

- **Partie 1 — Démarrer en 30 minutes** : l'essentiel pour rendre une école opérationnelle.
- **Partie 2 — Guide complet d'utilisation** : toutes les fonctionnalités, écran par écran.
- **Partie 3 — Guide parent** : à remettre aux familles.


---

# Partie 1 — Démarrer en 30 minutes


Le strict nécessaire pour rendre votre école opérationnelle sur GesSchool.

## Étape 1 — Créer l'école (5 min)
Inscription → **Je gère une école** → assistant en 3 étapes : identité (nom, sigle, logo), cycles ouverts, responsable + année scolaire (trimestres ou semestres). **L'année et les périodes sont créées automatiquement.**

## Étape 2 — Construire la structure (10 min) · menu *Structure*
1. Ajoutez vos **niveaux** (6e, CP, Seconde…).
2. **Générez les classes** en lot (base du nom + nombre + suffixe A/B/C).
3. Ajoutez les **matières** (avec code).
4. Lycée : créez les **séries** puis la **grille de coefficients**.

## Étape 3 — Inscrire les élèves (10 min) · menu *Élèves*
- **+ Nouvel élève** (un par un), ou **↑ Importer (Excel)** pour toute une liste.
- Astuce import : la colonne **Classe** doit correspondre exactement au libellé d'une classe créée à l'étape 2.

## Étape 4 — Préparer la facturation (5 min) · menu *Paiements*
1. Onglet **Grille tarifaire** : créez vos frais (Inscription, Scolarité…), cochez « obligatoire ».
2. Onglet **Paiement mobile** : saisissez vos numéros Wave / OM / Free Money.
3. **⚡ Générer en lot** : une facture par élève d'un niveau, en un clic.

## Ensuite, au quotidien
- **Notes** puis **Bulletins** (impression PDF en 1 clic).
- **Recouvrement** : relances automatiques des impayés + rappels push aux parents.
- **Espace parent** : générez un **Code parent** depuis la fiche élève et donnez-le aux familles.

---

Astuce : activez seulement les **modules** dont vous avez besoin (menu *Paramètres → Modules actifs*).

---

# Partie 2 — Guide complet d'utilisation
...
# Partie 3 — Guide parent


Suivez la scolarité de votre enfant et payez en ligne, depuis votre téléphone.

## 1. Créer votre compte
1. Ouvrez l'application GesSchool dans votre navigateur.
2. Onglet **Inscription** → votre e-mail + un mot de passe → **Créer le compte**.

## 2. Rejoindre votre enfant
1. Demandez à l'école votre **code de liaison** (8 caractères, ex. `3F9A2B7C`).
2. À l'écran d'accueil, choisissez **👪 Je suis un parent**.
3. Saisissez le code → **Accéder à l'espace parent**.

> Un seul code suffit même si vous avez plusieurs enfants dans l'école.

## 3. Consulter
Pour chaque enfant, des onglets : **Notes**, **Emploi du temps**, **Fournitures**, **Paiements**, **Absences**. Tout est mis à jour en temps réel par l'école.

## 4. Payer une facture (mobile money)
1. Onglet **Paiements** → bouton **Payer** sur la facture concernée.
2. Choisissez **Wave / Orange Money / Free Money** → le numéro de l'école s'affiche.
3. Payez depuis votre application mobile money, en indiquant le **numéro de facture** en référence.
4. Revenez et **Déclarez le paiement** (montant + réf. de la transaction).
5. L'école valide : la facture passe à « payée ».

## 5. Notifications
Activez les **notifications** pour être prévenu des nouvelles notes, absences, factures et rappels de paiement. Sur téléphone, « Ajouter à l'écran d'accueil » installe l'app comme une appli classique.
