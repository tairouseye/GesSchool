-- =====================================================================
--  026 — Appréciations & conseil de classe dans les bulletins parent
--  Ajoute l'appréciation par matière, l'appréciation générale et la
...
begin
  ...
  return query
    select b.id, p.libelle, p.ordre, b.moyenne_generale, b.rang, b.effectif, b.mention,
           b.appreciation_generale, b.decision,
