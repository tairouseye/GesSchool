-- =====================================================================
--  086 — RÉPARATION : recrée les objets de la 079 (workflow + audit) qui
--  n'avaient pas persisté (journal_audit manquant, cf. diagnostic).
--  Ne touche PAS aux statuts existants (la colonne statut est déjà en place,
--  garantie par la 085). Idempotent (create if not exists / or replace).
-- =====================================================================
